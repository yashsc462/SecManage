...
urlpatterns = [
    ...
    path('security_update_quotation/', views.security_update_quotation, name='security_update_quotation'),
    path('create-tax-invoice/', views.create_tax_invoice, name='create_tax_invoice'),
    path('admin_create-tax-invoice/', admin_views.admin_create_tax_invoice, name='admin_create_tax_invoice'),
    ...
    path('approve_advance/<int:pk>/', views.approve_advance, name='approve_advance'),
    path('reject_advance/<int:pk>/', views.reject_advance, name='reject_advance'),
    ...
    path('update_salary/<int:salary_id>/', admin_views.update_salary, name='update_salary'),
    ...
    path('view-pdf/<int:pk>/', views.view_pdf, name='view_pdf'),
   
    path('add_emp/', admin_views.add_emp, name='add_emp'),
    path('security_quotation/', admin_views.security_quotation, name='security_quotation'),

    path('admin_update-emp/<str:emp_id>/', admin_views.admin_update_emp, name='admin_update_emp'),
    path('salary_slip/<str:salary_id>/', views.pdf_generate, name='download_salary_slip'),
    path('emp_list', admin_views.emp_list, name='emp_list'),
    path('employees/view_pdf/<str:emp_id>/', admin_views.view_pdf, name='view_pdf'),
...
handler403 = 'secman.views.permission_denied_view'
